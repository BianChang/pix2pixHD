...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        # for setting inputs
        self.parser.add_argument('--dataroot', type=str, default=r'F:\2023_4_11_data_organization\1024_patches\debug_pix2pixHD')
        ...
        self.parser.add_argument('--preprocess', type=str, default='none',
